...
#ifndef ASIO_SSL_DETAIL_OPENSSL_ENGINE_HPP
#define ASIO_SSL_DETAIL_OPENSSL_ENTINE_HPP
...
private:
  ...
  ASIO_DECL want perform(int (engine::*op)(void *, std::size_t), void *data,
...
#include "asio/ssl/detail/impl/openssl_engine.ipp"
#endif // defined(ASIO_HEADER_ONLY)

#endif // ASIO_SSL_DETAIL_OPENSSL_ENGINE_HPP
